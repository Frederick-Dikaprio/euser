        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="{{ route('dashboard') }}"><img
                        src="{{ asset('images/logo.png') }}" alt="logo" style="height: 60px" /></a>
                <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard') }}"><img
                        src="{{ asset('images/logo.png') }}" alt="logo" style="width: 50px; height: 40px" /></a>
            </div>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas shadow-lg" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('all.price') }}">
                            <i class="icon-columns menu-icon"></i>
                            <span class="menu-title">Liste des prix</span>
                        </a>
                    </li>
                </ul>
            </nav>
